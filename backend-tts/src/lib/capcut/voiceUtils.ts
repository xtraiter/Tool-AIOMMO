...
export const resolveSpeaker = (
  ...
  if (requestedSpeaker) {
    ...
    // Vietnamese voices mappings
    const viVoiceMappings: Record<string, string> = {
      'BV421_vivn_streaming': '7252594014782755330',
      'vi_female_huong': '7264854897953083905',
      'BV074_streaming_dsp': '7550087831092251920',
      'BV074_streaming': '7102355709945188865',
      'BV075_streaming_vibrato_dsp': '7569450639810465040',
      'BV562_streaming': '7483736254694035984',
      'BV075_streaming': '7102355803792740865',
      'BV560_streaming': '7483736167565758992'
    };

    const actualId = viVoiceMappings[targetSpeaker] || '7102355803792740865';

    // Fallback: If not found in fetched list, try to use it directly instead of falling back to a Japanese voice
    return {
      title: targetSpeaker,
      ...
      resourceId: actualId,
      style: '',
      language: envLanguageFromSpeaker(targetSpeaker)
    };
  }
